...
|![Screenshot displaying the OpenAI API Key Onboarding view from Spezi OpenAI.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/OpenAIAPIKeyOnboardingStep.png#gh-light-mode-only) ![Screenshot displaying the OpenAI API Key onboarding  view.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/OpenAIAPIKeyOnboardingStep~dark.png#gh-dark-mode-only)|![Screenshot displaying the Open AI Model Selection Onboarding Step from Spezi OpenAI.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/OpenAIModelSelectionOnboardingStep.png#gh-light-mode-only) ![Screenshot displaying the Open AI Model Selection Onboarding Step.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/OpenAIModelSelectionOnboardingStep~dark.png#gh-dark-mode-only)|![Screenshot displaying the Chat View from Spezi OpenAI.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/ChatView.png#gh-light-mode-only) ![Screenshot displaying the Chat View.](Sources/SpeziOpenAI/SpeziOpenAI.docc/Resources/ChatView~dark.png#gh-dark-mode-only)|
|:--:|:--:|:--:|
