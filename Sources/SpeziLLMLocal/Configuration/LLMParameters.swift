...
public struct LLMParameters: Sendable {
    ...
    public enum Defaults {
        public static let defaultLlama2SystemPrompt: String = {
            String(localized: LocalizedStringResource("SPEZI_LLM_LOCAL_LLAMA_SYSTEM_PROMPT", bundle: .atURL(from: .module)))
        }()
    }
