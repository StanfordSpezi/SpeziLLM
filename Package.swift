...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/MacPaw/OpenAI", revision: "35afc9a6ee127b8f22a85a31aec2036a987478af"),    // No new release from MacPaw, use latest commit to main until release is tagged
